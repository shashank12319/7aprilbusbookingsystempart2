...
/**
    ...
    @return ResponseEntity object with the created Passenger object and HTTP status
    */
    @PostMapping
...
/**
    ...
    @return ResponseEntity object with the retrieved Passenger object and HTTP status
    */
