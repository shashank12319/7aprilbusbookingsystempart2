...
@return ResponseEntity object with the created StationDTO objects and HTTP status
*/
@PostMapping
...
@return ResponseEntity object with the retrieved StationDTO object and HTTP status
*/
@GetMapping("/{id}")
...
@return ResponseEntity object with the updated StationDTO object and HTTP status
*/
@PutMapping("/{id}")
...
@return ResponseEntity object with the list of StationDTO objects and HTTP status
*/
@GetMapping
